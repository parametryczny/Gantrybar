...
struct DefectMask: Codable, Equatable {
    ...
    enum Failure: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .invalid: return "Zaznacz poprawny obszar: co najmniej trzy punkty."
            case .image: return "Nie udało się przygotować obrazu do analizy."
            case .framing: return "Zmieniły się proporcje obrazu kamery. Popraw obszar wykrywania dla tej drukarki."
            }
        }
    }
