...
- **Live camera** — Bambu chamber camera over **RTSPS/RTSP** (native client, self‑signed certificate handled) and **Klipper/Creality** webcams via MJPEG, with a mode/resolution badge
...
- **Kamera na żywo** — kamera komory Bambu przez **RTSPS/RTSP** (natywny klient, obsługa self‑signed certyfikatu) oraz kamery **Klipper/Creality** przez MJPEG, z plakietką trybu i rozdzielczości
