...
- **wykrywanie wpadek z kamery**: Gantry ogląda klatkę z każdej drukującej maszyny co kilkanaście sekund i ostrzega, gdy kilka razy z rzędu widzi to samo nieszczęście. Ostrzeżenie idzie jako powiadomienie i na Telegram, a klatka, która je wywołała, zapisuje się do zbioru, bo to najcenniejsze zdjęcie do dalszej nauki. Opcjonalnie wydruk może zostać wstrzymany, domyślnie nie jest. Są dwie drogi: **wzorce z Twoich własnych klatek**, bez pliku modelu i bez trenowania, gdzie wystarczą trzy oznaczone zdjęcia danego rodzaju, żeby Gantry zaczęło je rozpoznawać, albo **wskazany plik Core ML**, jeśli masz własny wytrenowany model. Gantry nie wozi żadnego modelu: gotowe detektory z sieci mają licencje, które zabraniają rozdawania ich w cudzej aplikacji. Decyzja o alarmie jest osobnym, przetestowanym kawałkiem: potrzeba kilku zgodnych klatek z rzędu, jedna spokojna klatka nie kasuje trwającej wpadki, a o tej samej wpadce Gantry mówi raz, nie przy każdym spojrzeniu.
