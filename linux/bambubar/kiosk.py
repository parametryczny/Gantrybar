...
from .app import BambuBar, PrinterCard, TEXT
...
class KioskDashboard(Gtk.Window):
    def __init__(self, app: "KioskBambuBar") -> None:
...
class KioskPrinterCard(PrinterCard):
    def __init__(self, app: "KioskBambuBar", printer: Printer) -> None:
