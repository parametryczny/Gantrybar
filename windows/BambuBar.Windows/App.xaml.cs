...
public partial class App : Application
{
    ...
    private static readonly string LogPath = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "BambuBar", "error.log");

    /// <summary>Appends an exception to %AppData%\BambuBar\error.log so intermittent crashes can be
